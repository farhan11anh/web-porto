...
const Hero = () => {
  ...
  const typedItems = ["Frontend Developer", "Vue & React Expert", "Problem Solver", "Fast Learner"];
      ...
      >
        ...
        <div style={parallaxStyle}>
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hi, I'm <span className="text-[#00B4D8]">Farhan Ananto</span>
          </h1>
          <p className={`${styles.heroSubText} mt-2 text-white-100`}>
            ...
            <br />
            <b>3.5+ years building modern web apps across fintech, telco & education.</b>
          </p>
        </div>
      </div>
